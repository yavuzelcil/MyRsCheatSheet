...
\texttt{Pointer} is a variable that stores the memory address of another variable. In Rust, references are a kind of pointer that allow you to borrow a value without taking ownership of it.
